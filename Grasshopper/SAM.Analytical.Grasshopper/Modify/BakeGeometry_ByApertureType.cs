...
namespace SAM.Analytical.Grasshopper
{
    ...
    {
        public static void BakeGeometry_ByApertureType(this RhinoDoc rhinoDoc, global::Grasshopper.Kernel.Data.IGH_Structure gH_Structure, bool includeFrame = false)
        {
            if (rhinoDoc == null)
                return;
