    ...
    public class SAMAnalyticalMapInternalConditions : GH_SAMVariableOutputParameterComponent
    {
        ...
        protected override GH_SAMParam[] Outputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new GooSpaceParam() { Name = "unassignedSpaces", NickName = "unassignedSpaces", Description = "SAM Analytical Spaces has not been assigned", Access = GH_ParamAccess.list }, ParamVisibility.Voluntary));
