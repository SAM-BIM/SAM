...
";
        ...
        protected override GH_SAMParam[] Outputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Boolean() { Name = "accepted", NickName = "accepted", Description = "Was a feasible design found, and is analyticalModel therefore the resolved one rather than an unchanged copy? Read requestSatisfied separately for whether that design is the one asked for.", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
