...
namespace SAM.Analytical.Grasshopper
{
    public class SAMAnalyticalSetDefaultConstructionByPanelType : GH_SAMVariableOutputParameterComponent
    {
        ...
        protected override GH_SAMParam[] Outputs
        {
            ...
            {
                List<GH_SAMParam> result = new List<GH_SAMParam>();
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "Analytical", NickName = "Analytical", Description = "SAM Analytical Object with default constructions applied", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new GooPanelParam() { Name = "Panels", NickName = "Panels", Description = "SAM Analytical Panels modified with default constructions", Access = GH_ParamAccess.list }, ParamVisibility.Voluntary));
                return result.ToArray();
            }
        }
        ...
        public SAMAnalyticalSetDefaultConstructionByPanelType()
          : base("SAMAnalytical.SetDefaultConstructionByPanelType", "SAMAnalytical.SetDefaultConstructionByPanelType",
              "Sets default constructions on panels based on PanelType, applying only where the current construction does not follow the naming convention",
              "SAM", "Analytical03")
        {
        }
