    ...
    public class SAMAnalyticalUpdateInternalCondition : GH_SAMVariableOutputParameterComponent
    {
        ...
        public SAMAnalyticalUpdateInternalCondition()
          : base("SAMAnalytical.UpdateInternalCondition", "SAMAnalytical.UpdateInternalCondition",
              "Update or create InternalCondition properties for Spaces in an AnalyticalModel. If nothing is connected, the original model is output unchanged. A default NCM S37_OfficeCell IC with 8-to-18 gain profiles and constant set-point profiles is assigned. The original model is not modified; a copy is returned.",
              "SAM", "SAM_IC")
        {
        }
