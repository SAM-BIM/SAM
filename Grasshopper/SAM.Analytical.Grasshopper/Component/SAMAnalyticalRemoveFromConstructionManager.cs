...
{
    public class SAMAnalyticalRemoveFromConstructionManager : GH_SAMVariableOutputParameterComponent
    {
        /// <summary>
        /// Gets the unique ID for this component. Do not change this ID after release.
        /// </summary>
        public override Guid ComponentGuid => new Guid("64209b3d-94ca-46e3-b4b8-b8b141a7a149");
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            materials?.ForEach(x => constructionManager?.Remove(x));
            constructions?.ForEach(x => constructionManager?.Remove(x));
            apertureConstructions?.ForEach(x => constructionManager?.Remove(x));
