    ...
    public class SAMAnalyticalCreateInternalConditionByProfiles : GH_SAMVariableOutputParameterComponent
    {
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new GooAnalyticalModelParam() { Name = "_analyticalModel", NickName = "_analyticalModel", Description = "SAM AnalyticalModel to assign InternalConditions to", Access = GH_ParamAccess.item }, ParamVisibility.Binding));

                GooSpaceParam gooSpaceParam = new GooSpaceParam() { Name = "_spaces", NickName = "_spaces", Description = "SAM Analytical Spaces to assign InternalConditions to. All Spaces used if omitted.", Access = GH_ParamAccess.list };
                result.Add(new GH_SAMParam(gooSpaceParam, ParamVisibility.Binding));


                global::Grasshopper.Kernel.Parameters.Param_String @string = new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "ICname_", NickName = "ICname_", Description = "Name for the InternalCondition", Access = GH_ParamAccess.item, Optional = true };
                result.Add(new GH_SAMParam(@string, ParamVisibility.Binding));

                GooProfileParam gooProfileParam = new GooProfileParam() { Name = "_gainProfile_", NickName = "_gainProfile_", Description = "SAM Analytical Profile for all gains (occupancy, lighting, equipment). Default: 8to18.", Access = GH_ParamAccess.item };
                ...
                GooDegreeOfActivityParam gooDegreeOfActivityParam = new GooDegreeOfActivityParam() { Name = "_degreeOfActivity_", NickName = "_degreeOfActivity_", Description = "SAM Analytical DegreeOfActivity. Default: 'Moderate office work' (Sensible=75, Latent=55 W/person).", Access = GH_ParamAccess.item };
                ...
                number = new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "_areaPerPerson_", NickName = "_areaPerPerson_", Description = "Area per person [m²/person], default 10", Access = GH_ParamAccess.item };
                number.SetPersistentData(10);
                result.Add(new GH_SAMParam(number, ParamVisibility.Binding));

                number = new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "_occupancy_", NickName = "_occupancy_", Description = "Number of people. Overrides _areaPerPerson_ if supplied.", Access = GH_ParamAccess.item, Optional = true };
                result.Add(new GH_SAMParam(number, ParamVisibility.Binding));

                number = new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "_lightingGainPerArea_", NickName = "_lightingGainPerArea_", Description = "Lighting gain per floor area [W/m²], default 8", Access = GH_ParamAccess.item, Optional = true };
                number.SetPersistentData(8);
                result.Add(new GH_SAMParam(number, ParamVisibility.Binding));

                number = new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "_lightingLevel_", NickName = "_lightingLevel_", Description = "Lighting illuminance level [lux], default 500", Access = GH_ParamAccess.item };
                number.SetPersistentData(500);
                result.Add(new GH_SAMParam(number, ParamVisibility.Binding));

                number = new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "_equipmentSensGainPerArea_", NickName = "_equipmentSensGainPerArea_", Description = "Equipment sensible gain per floor area [W/m²], default 15", Access = GH_ParamAccess.item };
                number.SetPersistentData(15);
                result.Add(new GH_SAMParam(number, ParamVisibility.Binding));

                number = new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "_equipmentLatGainPerArea_", NickName = "_equipmentLatGainPerArea_", Description = "Equipment latent gain per floor area [W/m²], default 0", Access = GH_ParamAccess.item };
                number.SetPersistentData(0);
                result.Add(new GH_SAMParam(number, ParamVisibility.Binding));

                global::Grasshopper.Kernel.Parameters.Param_GenericObject genericObject = null;

                genericObject = new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "_heatingSetPoint_", NickName = "_heatingSetPoint_", Description = "Heating setpoint Profile or constant value [°C], default 21", Access = GH_ParamAccess.item };
                genericObject.SetPersistentData(21);
                result.Add(new GH_SAMParam(genericObject, ParamVisibility.Binding));

                genericObject = new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "_coolingSetPoint_", NickName = "_coolingSetPoint_", Description = "Cooling setpoint Profile or constant value [°C], default 24", Access = GH_ParamAccess.item };
                genericObject.SetPersistentData(24);
                result.Add(new GH_SAMParam(genericObject, ParamVisibility.Binding));

                genericObject = new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "_humidificationSetPoint_", NickName = "_humidificationSetPoint_", Description = "Humidification setpoint Profile or constant value [%], default 40", Access = GH_ParamAccess.item };
                genericObject.SetPersistentData(40);
                result.Add(new GH_SAMParam(genericObject, ParamVisibility.Binding));

                genericObject = new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "_dehumidificationSetPoint_", NickName = "_dehumidificationSetPoint_", Description = "Dehumidification setpoint Profile or constant value [%], default 60", Access = GH_ParamAccess.item };
                genericObject.SetPersistentData(60);
                result.Add(new GH_SAMParam(genericObject, ParamVisibility.Binding));

                number = new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "infiltrationACH_", NickName = "_infiltrationACH_", Description = "Infiltration air change rate [ACH], default 0.2 for spaces with external panels", Access = GH_ParamAccess.item, Optional = true };
                result.Add(new GH_SAMParam(number, ParamVisibility.Binding));

                number = new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "_pollutantGPerHrPerPerson_", NickName = "_pollutantGPerHrPerPerson_", Description = "Pollutant generation per person [g/hr/person], default 37.5", Access = GH_ParamAccess.item };
        ...
        protected override GH_SAMParam[] Outputs
        {
            ...
            {
                List<GH_SAMParam> result = new List<GH_SAMParam>();
                result.Add(new GH_SAMParam(new GooAnalyticalModelParam() { Name = "analyticalModel", NickName = "analyticalModel", Description = "SAM AnalyticalModel with updated InternalConditions and ProfileLibrary", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new GooInternalConditionParam() { Name = "internalConditions", NickName = "internalConditions", Description = "SAM Analytical InternalConditions created or updated", Access = GH_ParamAccess.list }, ParamVisibility.Voluntary));
                return result.ToArray();
            }
        }
        ...
        public SAMAnalyticalCreateInternalConditionByProfiles()
          : base("SAMAnalytical.CreateInternalConditionByProfiles", "SAMAnalytical.CreateInternalConditionByProfiles",
              "Create or update InternalConditions on Spaces within an AnalyticalModel using Profiles for gains and setpoints.",
              "SAM", "SAM_IC")
        {
        }
