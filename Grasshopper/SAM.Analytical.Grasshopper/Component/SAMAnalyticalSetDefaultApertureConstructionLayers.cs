...
namespace SAM.Analytical.Grasshopper
{
    public class SAMAnalyticalSetDefaultApertureConstructionLayers : GH_SAMVariableOutputParameterComponent
    {
        ...
        protected override GH_SAMParam[] Outputs
        {
            ...
            {
                List<GH_SAMParam> result = new List<GH_SAMParam>();
                result.Add(new GH_SAMParam(new GooAnalyticalObjectParam() { Name = "analytical", NickName = "analytical", Description = "SAM Analytical Object with default aperture construction layers applied", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
        ...
        public SAMAnalyticalSetDefaultApertureConstructionLayers()
          : base("SAMAdjacencyCluster.SetDefaultApertureConstructionLayers", "SAMAdjacencyCluster.SetDefaultApertureConstructionLayers",
              "Sets default ApertureConstruction layers on apertures based on PanelType and ApertureType, applying only where the current construction does not follow the naming convention",
              "SAM", "Analytical03")
        {
        }
