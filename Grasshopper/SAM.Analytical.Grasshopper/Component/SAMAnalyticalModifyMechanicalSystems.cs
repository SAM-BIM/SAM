    ...
    public class SAMAnalyticalModifyMechanicalSystems : GH_SAMVariableOutputParameterComponent
    {
        ...
        public SAMAnalyticalModifyMechanicalSystems()
          : base("SAMAnalytical.ModifyMechanicalSystems", "SAMAnalytical.ModifyMechanicalSystems",
              "Modify or assign mechanical systems (ventilation, heating, cooling) to Spaces in an AdjacencyCluster or AnalyticalModel. A copy of the original is created; the original remains unchanged.",
              "SAM", "Analytical02")
        {
        }
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new GooAnalyticalObjectParam() { Name = "_analytical", NickName = "_analytical", Description = "SAM AnalyticalObject (AdjacencyCluster or AnalyticalModel)", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
        ...
        protected override GH_SAMParam[] Outputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new GooSystemParam() { Name = "mechanicalSystems", NickName = "mechanicalSystems", Description = "SAM Analytical MechanicalSystems", Access = GH_ParamAccess.list }, ParamVisibility.Binding));
                return result.ToArray();
            }
        }
