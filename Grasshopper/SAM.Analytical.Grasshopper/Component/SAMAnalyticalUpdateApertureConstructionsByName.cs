...
namespace SAM.Analytical.Grasshopper
{
    public class SAMAnalyticalUpdateApertureConstructionsByName : GH_SAMVariableOutputParameterComponent
    {
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("d991aa5c-e7d5-4dc0-b888-c0e102a1a7a4");
        ...
        /// </summary>
        public SAMAnalyticalUpdateApertureConstructionsByName()
          : base("SAMAnalytical.UpdateApertureConstructionsByName", "SAMAnalytical.UpdateApertureConstructionsByName",
              "Automatically assign ApertureConstructions to Panels by matching construction names from a library. The original is not modified; a copy is returned.",
              "SAM", "Analytical04")
        {
        }
