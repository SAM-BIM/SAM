...
namespace SAM.Analytical.Grasshopper
{
    public class SAMAnalyticalCreateShellsByElevations : GH_SAMVariableOutputParameterComponent
    {
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            List<Shell> shells = Analytical.Query.Shells(panels, elevations, offset, 0.01, Core.Tolerance.MacroDistance, Core.Tolerance.MacroDistance, Core.Tolerance.MacroDistance, Core.Tolerance.Angle, tolerance);
