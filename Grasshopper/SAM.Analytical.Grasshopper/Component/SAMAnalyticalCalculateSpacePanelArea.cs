    ...
    public class SAMAnalyticalCalculateSpacePanelArea : GH_SAMVariableOutputParameterComponent
    {
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new GooAnalyticalObjectParam() { Name = "_analytical", NickName = "_analytical", Description = "SAM AnalyticalModel or AdjacencyCluster containing spaces and panels", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new GooSpaceParam() { Name = "spaces_", NickName = "spaces_", Description = "Spaces to calculate panel area for. If none connected, all spaces are processed.", Access = GH_ParamAccess.list, Optional = true }, ParamVisibility.Binding));
        ...
        protected override GH_SAMParam[] Outputs
        {
            ...
            {
                List<GH_SAMParam> result = new List<GH_SAMParam>();
                result.Add(new GH_SAMParam(new GooAnalyticalObjectParam() { Name = "analytical", NickName = "analytical", Description = "Input object with updated space panel area values", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
                return result.ToArray();
            }
        }
        ...
        public SAMAnalyticalCalculateSpacePanelArea()
          : base("SAMAnalytical.CalculateSpacePanelArea", "SAMAnalytical.CalculateSpacePanelArea",
              "Calculate the total surface area of panels belonging to each analytical space",
              "SAM", "Analytical")
        {
        }
