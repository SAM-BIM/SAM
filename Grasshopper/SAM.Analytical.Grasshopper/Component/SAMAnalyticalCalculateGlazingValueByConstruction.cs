    ...
    public class SAMAnalyticalCalculateGlazingValueByConstruction : GH_SAMVariableOutputParameterComponent
    {
        ...
        public SAMAnalyticalCalculateGlazingValueByConstruction()
          : base("SAMAnalytical.CalculateGlazingValueByConstruction", "SAMAnalytical.CalculateGlazingValueByConstruction",
              "Calculate glazing optical and thermal properties per construction in accordance with EN 410",
              "SAM WIP", "Tas")
        {
        }
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new GooAnalyticalModelParam() { Name = "_analyticalModel", NickName = "_analyticalModel", Description = "SAM AnalyticalModel containing the material library and construction definitions", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new GooAnalyticalObjectParam() { Name = "_constructions_", NickName = "_constructions_", Description = "Constructions to calculate glazing values for. If none connected, all transparent constructions are processed.", Access = GH_ParamAccess.list, Optional = true }, ParamVisibility.Binding));
        ...
        protected override GH_SAMParam[] Outputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new GooAnalyticalObjectParam() { Name = "Constructions", NickName = "Constructions", Description = "Constructions processed, in the same order as the tree branches", Access = GH_ParamAccess.list }, ParamVisibility.Binding));
