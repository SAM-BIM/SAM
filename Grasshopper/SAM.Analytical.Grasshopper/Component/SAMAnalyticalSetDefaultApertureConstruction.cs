    ...
    public class SAMAnalyticalSetDefaultApertureConstruction : GH_SAMVariableOutputParameterComponent
    {
        ...
        public SAMAnalyticalSetDefaultApertureConstruction()
          : base("SAMAdjacencyCluster.SetDefaultApertureConstruction", "SAMAdjacencyCluster.SetDefaultApertureConstruction",
              "Sets Default ApertureConstruction By PanelType and ApertureType for Adjacency Cluster only if currect ApertureConstruction does not follow naming convention ",
              "SAM", "Analytical03")
        {
        }
