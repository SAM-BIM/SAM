...
{
    public class SAMAnalyticalCreatePerimeterZones_2 : GH_SAMVariableOutputParameterComponent
    {
        /// <summary>
        /// Gets the unique ID for this component. Do not change this ID after release.
        /// </summary>
        public override Guid ComponentGuid => new Guid("4b795abf-c957-4e8c-9e02-afb6d3ec60f7");
        ...
        public SAMAnalyticalCreatePerimeterZones_2()
          : base("SAMAnalytical.CreatePerimeterZones_2", "SAMAnalytical.CreatePerimeterZones_2",
              "Create perimeter zones (variant 2 with adjustment offset) by splitting Spaces along external walls using a specified offset depth.",
              "SAM", "Analytical01")
        {
        }
        ...
        protected override GH_SAMParam[] Outputs
        {
            ...
            {
                List<GH_SAMParam> result = new List<GH_SAMParam>();
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject { Name = "analytical", NickName = "analytical", Description = "Updated SAM Analytical object with perimeter zones (variant 2)", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new GooGroupParam() { Name = "zones", NickName = "zones", Description = "Created SAM Analytical Zones (perimeter zones, variant 2)", Access = GH_ParamAccess.list }, ParamVisibility.Binding));
                return result.ToArray();
            }
        }
