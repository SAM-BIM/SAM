    ...
    public class SAMAnalyticalCreateInternalCondition : GH_SAMVariableOutputParameterComponent
    {
        ...
        public SAMAnalyticalCreateInternalCondition()
          : base("SAMAnalytical.CreateInternalCondition", "SAMAnalytical.CreateInternalCondition",
              "Create a SAM Analytical InternalCondition defining occupancy, equipment, lighting, ventilation, and HVAC loads for building performance simulation.",
              "SAM", "Analytical")
        {
        }
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                result.Add(new GH_SAMParam(new GooInternalConditionParam() { Name = "internalCondition_", NickName = "internalCondition_", Description = "Optional source SAM Analytical InternalCondition to inherit settings from", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "name_", NickName = "name_", Description = "Name for the InternalCondition", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "areaPerPerson_", NickName = "areaPerPerson_", Description = "Area per person [m²/person], default 10", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));

                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "occupancyProfile_", NickName = "occupancyProfile_", Description = "SAM Analytical Profile for occupancy schedule", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "occupancySensibleGainPerPerson_", NickName = "occupancySensibleGainPerPerson_", Description = "Occupancy sensible heat gain per person [W/person]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "occupancyLatentGainPerPerson_", NickName = "occupancyLatentGainPerPerson_", Description = "Occupancy latent heat gain per person [W/person]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));

                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "equipmentSensibleProfile_", NickName = "equipmentSensibleProfile_", Description = "SAM Analytical Profile for equipment sensible load schedule", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "equipmentSensibleGain_", NickName = "equipmentSensibleGain_", Description = "Equipment sensible heat gain (absolute) [W]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "equipmentLatentProfile_", NickName = "equipmentLatentProfile_", Description = "SAM Analytical Profile for equipment latent load schedule", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "equipmentLatentGain_", NickName = "equipmentLatentGain_", Description = "Equipment latent heat gain (absolute) [W]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "lightingProfile_", NickName = "lightingProfile_", Description = "SAM Analytical Profile for lighting schedule", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "lightingGain_", NickName = "lightingGain_", Description = "Lighting heat gain (absolute) [W]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "infiltrationProfile_", NickName = "infiltrationProfile_", Description = "SAM Analytical Profile for infiltration schedule", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "pollutantProfile_", NickName = "pollutantProfile_", Description = "SAM Analytical Profile for pollutant generation schedule", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "heatingProfile_", NickName = "heatingProfile_", Description = "SAM Analytical Profile for heating setpoint [°C]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "coolingProfile_", NickName = "coolingProfile_", Description = "SAM Analytical Profile for cooling setpoint [°C]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "humidificationProfile_", NickName = "humidificationProfile_", Description = "SAM Analytical Profile for humidification setpoint [%]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "dehumidificationProfile_", NickName = "dehumidificationProfile_", Description = "SAM Analytical Profile for dehumidification setpoint [%]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));

                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "ventilationSystemTypeName_", NickName = "ventilationSystemTypeName_", Description = "Ventilation system type name identifier", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "coolingSystemTypeName_", NickName = "coolingSystemTypeName_", Description = "Cooling system type name identifier", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "heatingSystemTypeName_", NickName = "heatingSystemTypeName_", Description = "Heating system type name identifier", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));

                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "ventilationProfile_", NickName = "ventilationProfile_", Description = "SAM Analytical Profile for ventilation schedule", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "supplyAirFlowPerPerson_", NickName = "supplyAirFlowPerPerson_", Description = "Supply air flow rate per person [m³/s/person]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "exhaustAirFlowPerPerson_", NickName = "exhaustAirFlowPerPerson_", Description = "Exhaust air flow rate per person [m³/s/person]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "supplyAirFlowPerArea_", NickName = "supplyAirFlowPerArea_", Description = "Supply air flow rate per floor area [m³/s/m²]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "exhaustAirFlowPerArea_", NickName = "exhaustAirFlowPerArea_", Description = "Exhaust air flow rate per floor area [m³/s/m²]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "supplyAirFlow_", NickName = "supplyAirFlow_", Description = "Supply air flow rate (absolute) [m³/s]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_Number() { Name = "exhaustAirFlow_", NickName = "exhaustAirFlow_", Description = "Exhaust air flow rate (absolute) [m³/s]", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                ...
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "lightingControlFunction_", NickName = "lightingControlFunction_", Description = "Lighting control function identifier (e.g. daylight dimming)", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "ventilationFunction_", NickName = "ventilationFunction_", Description = "Ventilation function identifier (e.g. demand-controlled)", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));

                result.Add(new GH_SAMParam(new GooAnalyticalObjectParam() { Name = "nCMData_", NickName = "nCMData_", Description = "National Calculation Method (NCM) compliance data", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));

                result.Add(new GH_SAMParam(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "description_", NickName = "description_", Description = "Description for the InternalCondition", Access = GH_ParamAccess.item, Optional = true }, ParamVisibility.Binding));
