...
namespace SAM.Analytical.Grasshopper
{
    public class SAMAddMissingMaterials : GH_SAMVariableOutputParameterComponent
    {
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("cbf81c43-d664-4fe9-9383-5df30e523248");
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            List<Core.IMaterial> materials = analyticalModel.AddMissingMaterials(materialLibrary, out List<string> missingMaterialNames);
