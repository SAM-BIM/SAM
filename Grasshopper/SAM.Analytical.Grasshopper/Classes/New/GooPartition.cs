...
namespace SAM.Analytical.Grasshopper
{
    ...
    public class GooPartition : GooJSAMObject<IPartition>, IGH_PreviewData, IGH_BakeAwareData
    {
            ...
            if (Value is IHostPartition)
            {
                ...
                if (openings != null)
                {
                    foreach (IOpening opening in openings)
                    {
                        ...
                        color_ExternalEdge = Analytical.Query.Color(opening, false);
                        color_InternalEdges = Analytical.Query.Color(opening, true);
        ...
        public void DrawViewportMeshes(GH_PreviewMeshArgs args)
        {
            ...
            global::Rhino.Display.DisplayMaterial displayMaterial = Query.DisplayMaterial(Value);
                ...
                if (openings != null)
                {
                    foreach (IOpening opening in openings)
                    {
                        ...
                        if (edge3Ds != null && edge3Ds.Count != 0)
                        {
                            ...
                            {
                                global::Rhino.Display.DisplayMaterial displayMaterial_Opening = Query.DisplayMaterial(opening);
