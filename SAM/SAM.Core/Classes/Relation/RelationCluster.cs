...
namespace SAM.Core
{
    ...
    public class RelationCluster<X> : SAMObject, IRelationCluster
    {
        ...
        public List<T> GetRelatedObjects<T>(LogicalOperator logicalOperator, params X[] objects) where T : X
        {
            if (objects == null)
            {
                return null;
            ...
            return GetRelatedObjects<T>(logicalOperator, guids.ToArray());
        }
        ...
        public bool RemoveObject(X @object)
        {
            ...
            return RemoveObject(@object.GetType(), guid);
        }
