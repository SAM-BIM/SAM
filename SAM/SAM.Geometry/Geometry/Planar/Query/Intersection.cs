...
namespace SAM.Geometry.Planar
{
    ...
    {
        /// <summary>
        /// Intersection of two segments represented by four point2Ds with given tolerance.
        /// </summary>
        ...
        public static Point2D Intersection(Point2D point2D_1_Start, Point2D point2D_1_End, Point2D point2D_2_Start, Point2D point2D_2_End, bool bounded = true, double tolerance = Core.Tolerance.Distance)
        {
            Point2D point2D_Closest1 = null;
            Point2D point2D_Closest2 = null;

            Point2D point2D_Intersection = Intersection(point2D_1_Start, point2D_1_End, point2D_2_Start, point2D_2_End, out point2D_Closest1, out point2D_Closest2, tolerance);
        ...
        /// <returns></returns>
        public static Point2D Intersection(Point2D point2D_1_Start, Point2D point2D_1_End, Point2D point2D_2_Start, Point2D point2D_2_End, out Point2D point2D_Closest1, out Point2D point2D_Closest2, double tolerance = Core.Tolerance.Distance)
        {
